...
import com.example.component.DialogInsured;
import com.example.component.IbanForm;
import com.example.component.InsuredGrid;
...
public class ContributionDetailsView extends VerticalLayout {
    ...
    private void loadPreviousPeriod() {
        ...
        loadDataDialog.setHeaderTitle("Recuperar dades periodo anterior");
        ...
        loadDataDialog.getFooter().add(btnConfirm,btnCancel);
        loadDataDialog.open();
    }
    ...
    private Component paginationInsuredList() {
        ...
        last.getStyle().setMarginRight("1rem");
        footer.setWidthFull();
